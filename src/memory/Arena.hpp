...
PYLANG_GC_FORCE_TRIVIAL(py::PyStringIterator)
PYLANG_GC_FORCE_TRIVIAL(py::PyDictItemsIterator)
...
PYLANG_GC_FORCE_TRIVIAL(py::PyObject)
PYLANG_GC_FORCE_TRIVIAL(py::PyDict)
PYLANG_GC_FORCE_TRIVIAL(py::PyDictItems)
